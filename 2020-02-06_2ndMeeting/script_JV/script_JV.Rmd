...
---
background-image: url(img/viz.png), url(img/data-import.png), url(img/data-transformation.png), url(img/rmarkdown-2.0.png), url(img/factors.png)
background-position: 10%90%, 30%75%, 50%60%, 60%40%, 90%10%
