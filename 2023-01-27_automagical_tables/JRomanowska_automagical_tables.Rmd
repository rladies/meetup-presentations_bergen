...
```{r table1_finalfit_example, include = FALSE}
explanatory <- c(
  "age",
  "age.factor",
  "sex.factor",
...
`r chunk_reveal("table1_finalfit_example", break_type = "user", chunk_options = "warning = FALSE", font_size_code = "50%", widths = c(0.45, 0.5))`

---

```{r table2_finalfit_example, include = FALSE}
explanatory <- c(
  "age.factor",
  "sex.factor",
  "obstruct.factor",
...
`r chunk_reveal("table2_finalfit_example", break_type = "user", chunk_options = "warning = FALSE", font_size_code = "50%", widths = c(0.45, 0.5))`
...
```{r table2_parameters, include = FALSE}
model <- lm(
  Sepal.Length ~ Species * Petal.Length,
  data = iris
) #BREAK
model_parameters(model) #BREAK

mp <- model_parameters(model)
print_md(mp) #BREAK
```

`r chunk_reveal("table2_parameters", break_type = "user", chunk_options = "warning = FALSE", font_size_code = "50%", widths = c(0.4, 0.55))`
